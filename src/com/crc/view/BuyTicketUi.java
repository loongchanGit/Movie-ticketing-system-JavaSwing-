...
import com.crc.service.impl.TicketServiceImpl;
...
public class BuyTicketUi extends JFrame implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		// TODO Auto-generated method stub
		Object obj = e.getSource();//获取对象资源
		for (int i = 0; i < num; i++) {//循环读取对象
			if (obj == btlist[i]) {
				sb.append(i + 1 + " ");
				btlist[i].setBackground(Color.ORANGE);
				seatlist.add(Integer.parseInt(btlist[i].getText()));//集合添加值
				btlist[i].setEnabled(false);
				lblRe.setText(sb + "");
			}
		}
