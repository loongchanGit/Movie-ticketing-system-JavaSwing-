...
import com.crc.service.CommentService;
import com.crc.service.UserService;
import com.crc.service.impl.CommentServiceImpl;
...
public class MovieUi {
	...
	if(canreport) {
	  if("".equals(jcommentcontent.getText())) {
		...
		Comment comm=new Comment(u.getUid(),movie.getmId(),jcommentcontent.getText(),date);
